...
themeButton.addEventListener("click", () => {
  //Add or remove the dark / icon mode
...
sr.reveal(
  ".home__data, .featured__container, .new__container, .join__data, .testimonial__container, .footer, .js__container"
);
sr.reveal(".home__images", { delay: 600 });
sr.reveal(".services__card", { interval: 100 });
sr.reveal(".discount__data", { origin: "left" });
sr.reveal(".discount__images, .about__images", { origin: "right" });
